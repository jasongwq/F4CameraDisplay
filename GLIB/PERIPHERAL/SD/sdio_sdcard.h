...
#define SDIO_INIT_CLK_DIV        0x76// 0xB2 stm32f1       //SDIO初始化频率，最大400Kh  
//#define SDIO_TRANSFER_CLK_DIV    0x02// 0x02 stm32f1       //SDIO传输频率，最大24Mhz(4bit)。该值太小可能会导致读写文件出错 
#define SDIO_TRANSFER_CLK_DIV    0x04       //SDIO传输频率，最大24Mhz(4bit)。该值太小可能会导致读写文件出错 

#define SDIO_BUSWIDE_BIT SDIO_BusWide_1b
