...
//ALIENTEK 使用A10作为RS（区分读/写）
//A11为偏移地址为100 0000 0000
//typedef struct
//{
//    u16 LCD_REG;
//    u16 LCD_RAM;
//} LCD_TypeDef;//LCD_RAM地址为(0x6000 0000|0x0000 0800)
//因为值为16位数据 
//所以 LCD_REG地址为(0x6000 0000|0x0000 0800)-2=(0x6000 0000|0x0000 07FE)
//
...
#define GLCD_ShowNum(x,y,num,size) LCD_ShowNum(x,y,num,size,16)
