...
//    // GPIO_SetBits(LCD_RST_GPIO, LCD_RST_Pin); //复位
//    // delay_ms(1);
//    // GPIO_ResetBits(LCD_RST_GPIO, LCD_RST_Pin); //复位
//    // delay_ms(10);
//    // GPIO_SetBits(LCD_RST_GPIO, LCD_RST_Pin); //复位
//    // delay_ms(120);
//    /*-- FSMC Configuration ------------------------------------------------------*/
...
{
    LCD_LIGHT_INIT LCD_RST_INIT LCD_LIGHT_H///; Set_C5
}
//初始化函数
void LCD_Init(void)
{
