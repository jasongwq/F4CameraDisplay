...
#define PH0_OUT   My_GPIO_Init(GPIOH,GPIO_Pin_0,1);
#define PH1_OUT   My_GPIO_Init(GPIOH,GPIO_Pin_1,1);
#define PH2_OUT   My_GPIO_Init(GPIOH,GPIO_Pin_2,1);
#define PH3_OUT   My_GPIO_Init(GPIOH,GPIO_Pin_3,1);
#define PH4_OUT   My_GPIO_Init(GPIOH,GPIO_Pin_4,1);
#define PH5_OUT   My_GPIO_Init(GPIOH,GPIO_Pin_5,1);
#define PH6_OUT   My_GPIO_Init(GPIOH,GPIO_Pin_6,1);
#define PH7_OUT   My_GPIO_Init(GPIOH,GPIO_Pin_7,1);
#define PH8_OUT   My_GPIO_Init(GPIOH,GPIO_Pin_8,1);
#define PH9_OUT   My_GPIO_Init(GPIOH,GPIO_Pin_9,1);
#define PH10_OUT  My_GPIO_Init(GPIOH,GPIO_Pin_10,1);
#define PH11_OUT  My_GPIO_Init(GPIOH,GPIO_Pin_11,1);
#define PH12_OUT  My_GPIO_Init(GPIOH,GPIO_Pin_12,1);
#define PH13_OUT  My_GPIO_Init(GPIOH,GPIO_Pin_13,1);
#define PH14_OUT  My_GPIO_Init(GPIOH,GPIO_Pin_14,1);
#define PH15_OUT  My_GPIO_Init(GPIOH,GPIO_Pin_15,1);

#define PI0_OUT   My_GPIO_Init(GPIOI,GPIO_Pin_0,1);
#define PI1_OUT   My_GPIO_Init(GPIOI,GPIO_Pin_1,1);
#define PI2_OUT   My_GPIO_Init(GPIOI,GPIO_Pin_2,1);
#define PI3_OUT   My_GPIO_Init(GPIOI,GPIO_Pin_3,1);
#define PI4_OUT   My_GPIO_Init(GPIOI,GPIO_Pin_4,1);
#define PI5_OUT   My_GPIO_Init(GPIOI,GPIO_Pin_5,1);
#define PI6_OUT   My_GPIO_Init(GPIOI,GPIO_Pin_6,1);
#define PI7_OUT   My_GPIO_Init(GPIOI,GPIO_Pin_7,1);
#define PI8_OUT   My_GPIO_Init(GPIOI,GPIO_Pin_8,1);
#define PI9_OUT   My_GPIO_Init(GPIOI,GPIO_Pin_9,1);
#define PI10_OUT  My_GPIO_Init(GPIOI,GPIO_Pin_10,1);
#define PI11_OUT  My_GPIO_Init(GPIOI,GPIO_Pin_11,1);
#define PI12_OUT  My_GPIO_Init(GPIOI,GPIO_Pin_12,1);
#define PI13_OUT  My_GPIO_Init(GPIOI,GPIO_Pin_13,1);
#define PI14_OUT  My_GPIO_Init(GPIOI,GPIO_Pin_14,1);
#define PI15_OUT  My_GPIO_Init(GPIOI,GPIO_Pin_15,1);
...
#define PH0_In   My_GPIO_Init(GPIOH,GPIO_Pin_0,0);
#define PH1_In   My_GPIO_Init(GPIOH,GPIO_Pin_1,0);
#define PH2_In   My_GPIO_Init(GPIOH,GPIO_Pin_2,0);
#define PH3_In   My_GPIO_Init(GPIOH,GPIO_Pin_3,0);
#define PH4_In   My_GPIO_Init(GPIOH,GPIO_Pin_4,0);
#define PH5_In   My_GPIO_Init(GPIOH,GPIO_Pin_5,0);
#define PH6_In   My_GPIO_Init(GPIOH,GPIO_Pin_6,0);
#define PH7_In   My_GPIO_Init(GPIOH,GPIO_Pin_7,0);
#define PH8_In   My_GPIO_Init(GPIOH,GPIO_Pin_8,0);
#define PH9_In   My_GPIO_Init(GPIOH,GPIO_Pin_9,0);
#define PH10_In  My_GPIO_Init(GPIOH,GPIO_Pin_10,0);
#define PH11_In  My_GPIO_Init(GPIOH,GPIO_Pin_11,0);
#define PH12_In  My_GPIO_Init(GPIOH,GPIO_Pin_12,0);
#define PH13_In  My_GPIO_Init(GPIOH,GPIO_Pin_13,0);
#define PH14_In  My_GPIO_Init(GPIOH,GPIO_Pin_14,0);
#define PH15_In  My_GPIO_Init(GPIOH,GPIO_Pin_15,0);

#define PI0_In   My_GPIO_Init(GPIOI,GPIO_Pin_0,0);
#define PI1_In   My_GPIO_Init(GPIOI,GPIO_Pin_1,0);
#define PI2_In   My_GPIO_Init(GPIOI,GPIO_Pin_2,0);
#define PI3_In   My_GPIO_Init(GPIOI,GPIO_Pin_3,0);
#define PI4_In   My_GPIO_Init(GPIOI,GPIO_Pin_4,0);
#define PI5_In   My_GPIO_Init(GPIOI,GPIO_Pin_5,0);
#define PI6_In   My_GPIO_Init(GPIOI,GPIO_Pin_6,0);
#define PI7_In   My_GPIO_Init(GPIOI,GPIO_Pin_7,0);
#define PI8_In   My_GPIO_Init(GPIOI,GPIO_Pin_8,0);
#define PI9_In   My_GPIO_Init(GPIOI,GPIO_Pin_9,0);
#define PI10_In  My_GPIO_Init(GPIOI,GPIO_Pin_10,0);
#define PI11_In  My_GPIO_Init(GPIOI,GPIO_Pin_11,0);
#define PI12_In  My_GPIO_Init(GPIOI,GPIO_Pin_12,0);
#define PI13_In  My_GPIO_Init(GPIOI,GPIO_Pin_13,0);
#define PI14_In  My_GPIO_Init(GPIOI,GPIO_Pin_14,0);
#define PI15_In  My_GPIO_Init(GPIOI,GPIO_Pin_15,0);
...
#define	Set_H0   GPIOH->BSRRL=1<<0 ;
#define	Set_H1   GPIOH->BSRRL=1<<1;
#define	Set_H2   GPIOH->BSRRL=1<<2;
#define	Set_H3   GPIOH->BSRRL=1<<3;
#define	Set_H4   GPIOH->BSRRL=1<<4;
#define	Set_H5   GPIOH->BSRRL=1<<5;
#define	Set_H6   GPIOH->BSRRL=1<<6;
#define	Set_H7   GPIOH->BSRRL=1<<7;
#define	Set_H8   GPIOH->BSRRL=1<<8;
#define	Set_H9   GPIOH->BSRRL=1<<9 ;
#define	Set_H10  GPIOH->BSRRL=1<<10;
#define	Set_H11  GPIOH->BSRRL=1<<11;
#define	Set_H12  GPIOH->BSRRL=1<<12;
#define	Set_H13  GPIOH->BSRRL=1<<13;
#define	Set_H14  GPIOH->BSRRL=1<<14;
#define	Set_H15  GPIOH->BSRRL=1<<15;
#define	Set_H(n) GPIOH->BSRRL=1<<n;

#define	Set_I0   GPIOI->BSRRL=1<<0 ;
#define	Set_I1   GPIOI->BSRRL=1<<1;
#define	Set_I2   GPIOI->BSRRL=1<<2;
#define	Set_I3   GPIOI->BSRRL=1<<3;
#define	Set_I4   GPIOI->BSRRL=1<<4;
#define	Set_I5   GPIOI->BSRRL=1<<5;
#define	Set_I6   GPIOI->BSRRL=1<<6;
#define	Set_I7   GPIOI->BSRRL=1<<7;
#define	Set_I8   GPIOI->BSRRL=1<<8;
#define	Set_I9   GPIOI->BSRRL=1<<9 ;
#define	Set_I10  GPIOI->BSRRL=1<<10;
#define	Set_I11  GPIOI->BSRRL=1<<11;
#define	Set_I12  GPIOI->BSRRL=1<<12;
#define	Set_I13  GPIOI->BSRRL=1<<13;
#define	Set_I14  GPIOI->BSRRL=1<<14;
#define	Set_I15  GPIOI->BSRRL=1<<15;
#define	Set_I(n) GPIOI->BSRRL=1<<n;
...
#define	Clr_H0   GPIOH->BSRRH=1<<0 ;
#define	Clr_H1   GPIOH->BSRRH=1<<1;
#define	Clr_H2   GPIOH->BSRRH=1<<2;
#define	Clr_H3   GPIOH->BSRRH=1<<3;
#define	Clr_H4   GPIOH->BSRRH=1<<4;
#define	Clr_H5   GPIOH->BSRRH=1<<5;
#define	Clr_H6   GPIOH->BSRRH=1<<6;
#define	Clr_H7   GPIOH->BSRRH=1<<7;
#define	Clr_H8   GPIOH->BSRRH=1<<8;
#define	Clr_H9   GPIOH->BSRRH=1<<9 ;
#define	Clr_H10  GPIOH->BSRRH=1<<10;
#define	Clr_H11  GPIOH->BSRRH=1<<11;
#define	Clr_H12  GPIOH->BSRRH=1<<12;
#define	Clr_H13  GPIOH->BSRRH=1<<13;
#define	Clr_H14  GPIOH->BSRRH=1<<14;
#define	Clr_H15  GPIOH->BSRRH=1<<15;
#define	Clr_H(n) GPIOH->BSRRH=1<<n;
 
#define	Clr_I0   GPIOI->BSRRH=1<<0 ;
#define	Clr_I1   GPIOI->BSRRH=1<<1;
#define	Clr_I2   GPIOI->BSRRH=1<<2;
#define	Clr_I3   GPIOI->BSRRH=1<<3;
#define	Clr_I4   GPIOI->BSRRH=1<<4;
#define	Clr_I5   GPIOI->BSRRH=1<<5;
#define	Clr_I6   GPIOI->BSRRH=1<<6;
#define	Clr_I7   GPIOI->BSRRH=1<<7;
#define	Clr_I8   GPIOI->BSRRH=1<<8;
#define	Clr_I9   GPIOI->BSRRH=1<<9 ;
#define	Clr_I10  GPIOI->BSRRH=1<<10;
#define	Clr_I11  GPIOI->BSRRH=1<<11;
#define	Clr_I12  GPIOI->BSRRH=1<<12;
#define	Clr_I13  GPIOI->BSRRH=1<<13;
#define	Clr_I14  GPIOI->BSRRH=1<<14;
#define	Clr_I15  GPIOI->BSRRH=1<<15;
...
#define H0       ((GPIOH->IDR&(1<<0))?1:0)
#define H1       ((GPIOH->IDR&(1<<1))?1:0)
#define H2       ((GPIOH->IDR&(1<<2))?1:0)
#define H3       ((GPIOH->IDR&(1<<3))?1:0)
#define H4       ((GPIOH->IDR&(1<<4))?1:0)
#define H5       ((GPIOH->IDR&(1<<5))?1:0)
#define H6       ((GPIOH->IDR&(1<<6))?1:0)
#define H7       ((GPIOH->IDR&(1<<7))?1:0)
#define H8       ((GPIOH->IDR&(1<<8))?1:0)
#define H9       ((GPIOH->IDR&(1<<9))?1:0)
#define H10      ((GPIOH->IDR&(1<<10))?1:0)
#define H11      ((GPIOH->IDR&(1<<11))?1:0)
#define H12      ((GPIOH->IDR&(1<<12))?1:0)
#define H13      ((GPIOH->IDR&(1<<13))?1:0)
#define H14      ((GPIOH->IDR&(1<<14))?1:0)
#define H15      ((GPIOH->IDR&(1<<15))?1:0)
#define H(n)     ((GPIOH->IDR&(1<<n))?1:0)

#define I0       ((GPIOI->IDR&(1<<0))?1:0)
#define I1       ((GPIOI->IDR&(1<<1))?1:0)
#define I2       ((GPIOI->IDR&(1<<2))?1:0)
#define I3       ((GPIOI->IDR&(1<<3))?1:0)
#define I4       ((GPIOI->IDR&(1<<4))?1:0)
#define I5       ((GPIOI->IDR&(1<<5))?1:0)
#define I6       ((GPIOI->IDR&(1<<6))?1:0)
#define I7       ((GPIOI->IDR&(1<<7))?1:0)
#define I8       ((GPIOI->IDR&(1<<8))?1:0)
#define I9       ((GPIOI->IDR&(1<<9))?1:0)
#define I10      ((GPIOI->IDR&(1<<10))?1:0)
#define I11      ((GPIOI->IDR&(1<<11))?1:0)
#define I12      ((GPIOI->IDR&(1<<12))?1:0)
#define I13      ((GPIOI->IDR&(1<<13))?1:0)
#define I14      ((GPIOI->IDR&(1<<14))?1:0)
#define I15      ((GPIOI->IDR&(1<<15))?1:0)
#define I(n)     ((GPIOI->IDR&(1<<n))?1:0)
