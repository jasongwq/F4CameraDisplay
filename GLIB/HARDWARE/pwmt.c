...
void TIM_SetCompare1(TIM2,100)；
void TIM_SetCompare2(TIM2,200)；
void TIM_SetCompare3(TIM2,300)；
void TIM_SetCompare4(TIM2,400);
*/
/*****************************************************
REMAP        |   00    |   01    |   10    |   11    |
*****************************************************|
...
//arr：自动重装
//psc：时钟预分频数
#if defined (PWM_TIM2_CH1)||defined (PWM_TIM2_CH2)||defined (PWM_TIM2_CH3)||defined (PWM_TIM2_CH4)
...
//arr：自动重装值
//psc：时钟预分频数
#if defined (PWM_TIM3_CH1)||defined (PWM_TIM3_CH2)||defined (PWM_TIM3_CH3)||defined (PWM_TIM3_CH4)
...
//arr：自动重装值
//psc：时钟预分频数
#if defined (PWM_TIM4_CH1)||defined (PWM_TIM4_CH2)||defined (PWM_TIM4_CH3)||defined (PWM_TIM4_CH4)
...
//arr：自动重装值
//psc：时钟预分频数
#if defined (PWM_TIM5_CH1)||defined (PWM_TIM5_CH2)||defined (PWM_TIM5_CH3)||defined (PWM_TIM5_CH4)
...
//arr：自动重装值
//psc：时钟预分频数
#if defined (PWM_TIM8_CH1)||defined (PWM_TIM8_CH2)||defined (PWM_TIM8_CH3)||defined (PWM_TIM8_CH4)
...
//arr：自动重装值
//psc：时钟预分频数
#if defined (PWM_TIM1_CH1)||defined (PWM_TIM1_CH2)||defined (PWM_TIM1_CH3)||defined (PWM_TIM1_CH4)
