 ...
 *               Driver_UART4, Driver_UART5, Driver_UART6 
...
#define __UART1_FLOW_CONTROL_THRESHOLD  16  // Buffer size must be 2^n
#endif
...
#define __UART2_FLOW_CONTROL_THRESHOLD  16  // Buffer size must be 2^n
#endif
...
#define __UART3_FLOW_CONTROL_THRESHOLD  16  // Buffer size must be 2^n
#endif
...
#define __UART4_FLOW_CONTROL_THRESHOLD  16  // Buffer size must be 2^n
#endif
...
#define __UART6_FLOW_CONTROL_THRESHOLD  16  // Buffer size must be 2^n
#endif
...
/* UART Resources */
static UART_RESOURCES *ptr_UART[6] = {
#if (RTE_USART1 != 0)
  &UART1_Resources,
#else
  NULL,
